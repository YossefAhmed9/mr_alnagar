...
class CourseReservationScreen extends StatelessWidget {
  const CourseReservationScreen({Key? key,required this.data}) : super(key: key);
final data;
  @override
  Widget build(BuildContext context) {
    return BlocConsumer<CoursesCubit, CoursesState>(
      ...
      builder: (context, state) {
        ...
        return CoursesCubit.get(context).courseResult.isEmpty ?  Center(child: CircularProgressIndicator(color: AppColors.primaryColor,),)  :
        ...
        Directionality(
          ...
          child: Scaffold(
            ...
            //   //CoursesCubit.get(context).enrollInCourse(courseID: 4, paymentType: 'pay_in_center');
            //
            // }),
            bottomNavigationBar: Padding(
              ...
              child: Builder(
                builder: (context) {
                  final course = CoursesCubit.get(context).courseResult[0];
                          ...
                          child: MaterialButton(
                            onPressed: isDisabled
                              ...
                              if (status == 'approved') {
                                ...
                                CoursesCubit.get(context).enrollInCourse(
                                  courseID: course['id'],
          ...
          //             }),
            appBar: AppBar(
              ...
              title: Text(CoursesCubit.get(context).courseResult[0]['title'], style: TextStyles.textStyle16w700(context)),
              centerTitle: true,
            ),
              ...
              child: Padding(
                ...
                child: Column(
                  ...
                  children: [
                                ...
                                child: Padding(
                                  ...
                                  child: Row(
                                    ...
                                    children: [
                                      ...
                                      Text('${CoursesCubit.get(context).courseResult[0][counts[index]]}',
                    ...
                    Text(
                        HtmlUnescape().convert(CoursesCubit.get(context).courseResult[0]['note'])
                            .replaceAll(RegExp(r'<[^>]*>'), '')
                    ...
                    Padding(
                      ...
                      child: Container(
                          ...
                          child: Image.network(CoursesCubit.get(context).courseResult[0]['image']),
                      ),
                    ),
                    Text('محتوى الإشتراك الشهري',
                      style: TextStyles.textStyle16w700(context),),

                    Text( HtmlUnescape().convert('${CoursesCubit.get(context).courseResult[0]['description']}')

    ...
    return Scaffold(
      body: RefreshIndicator(
        ...
        onRefresh: (){
          ...
          _loadVideos();
          return   CoursesCubit.get(context).getVideosByCourse(id: widget.videoIndex,context: context);
                                      ...
                                      children: [
                                        ...
                                        section['has_homeworks'] == true
                                            ? _buildActionButton(context, Icons.assignment, 'حل الواجب', () async{
                                              controller.pause();
                                          await CoursesCubit.get(context).startHomework(homeworkId: CoursesCubit.get(context).coursesVideos['sections_data'][sectionIndex]['homework_id'],);

                                          Navigator.push(context, CupertinoPageRoute(builder: (context){
                                            return HomeworkView(homeworkID: CoursesCubit.get(context).coursesVideos['sections_data'][sectionIndex]['homework_id'],);
                                          }));
                                            })
                                            : Container(),
                                        section['has_quizzes'] == true
                                            ? _buildActionButton(context, Icons.quiz, 'عرض الامتحان', () async{
                                              CoursesCubit.get(context).changeIsCourseLoading();
                                          await  CoursesCubit.get(context).startQuiz(quizId: CoursesCubit.get(context).coursesVideos['sections_data'][sectionIndex]['quiz_id']);
                                          print(CoursesCubit.get(context).coursesVideos['sections_data'][sectionIndex]['quiz_id']);
                                              showDialog(
                                                context: context,
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  CoursesCubit.get(context).quiz == null
                                                                    ...
                                                                    child: Text(
                                                                      HtmlUnescape().convert(CoursesCubit.get(context)
                                                                        ...
                                                                        onPressed: () async {
                                                                          ...
                                                                          await CoursesCubit.get(context).startQuiz(
                                                                            quizId: CoursesCubit.get(context)
                                                                                .coursesVideos['sections_data'][sectionIndex]
                                                                            ['quiz_id'],
                                                                          );

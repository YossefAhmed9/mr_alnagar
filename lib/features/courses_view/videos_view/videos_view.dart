...
class _CourseVideoScreenState extends State<CourseVideoScreen> {
  ...
  void initState() {
    ...
    CoursesCubit.get(
      context,
    ).getVideosByCourse(id: widget.videoIndex, context: context);
  ...
  void _loadVideos() {
    ...
    for (var section in sections) {
      ...
      sectionsList.add({
        ...
        'homework_attempted': section['homework_attempted'],
        'videos': videos,
      });
    }
  ...
  void showLoadOnRefresh() async {
    isLoad = true;
    await CoursesCubit.get(context)
        .getVideosByCourse(
    ...
    Future.delayed(Duration(seconds: 2)).then((value) {
      setState(() async {
        ...
        Navigator.push(
          ...
          CupertinoPageRoute(
            builder:
                (context) => CourseVideoScreen(
                  videoIndex: CoursesCubit.get(context).courseResult[0]['id'],
                ),
          ),
        );
        isLoad = false;
                                                    ...
                                                    return Container(
                                                      ...
                                                      child: ExpansionTile(
                                                        ...
                                                        initiallyExpanded:
                                                            ...
                                                            CoursesCubit.get(
                                                              context,
                                                            ).coursesVideos['sections_data'][sectionIndex]['id'],
                                                        title: Column(
                                                          crossAxisAlignment:
                                                              CrossAxisAlignment
                                                                  .start,
                                                                    ...
                                                                    ? _buildActionButton(
                                                                      ...
                                                                      () async {
                                                                        var url =
                                                                            CoursesCubit.get(
                                                                              context,
                                                                            ).coursesVideos[sectionIndex]['attachment'];
                                                                        if (url !=
                                                                                null &&
                                                                      ...
                                                                      () async {
                                                                        ...
                                                                        await CoursesCubit.get(
                                                                          ...
                                                                          homeworkId:
                                                                              CoursesCubit.get(
                                                                                context,
                                                                              ).coursesVideos['sections_data'][sectionIndex]['homework_id'],
                                                                        );
                                                            ...
                                                            >((video) {
                                                              ...
                                                              return InkWell(
                                                                onTap: () {
                                                                  ...
                                                                  final hasHomework =
                                                                      parentSection['has_homeworks'];
                                                                  final homeworkAttempted =
                                                                      parentSection['homework_attempted'];
                                                                    ...
                                                                    showDialog(
                                                                      ...
                                                                      builder:
                                                                          (
                                                                            ...
                                                                            content: Text(
                                                                              'يجب عليك حل الواجب أولاً لمشاهدة الفيديوهات',
                                                                              textAlign:
                                                                                  TextAlign.center,
                                                                              style: TextStyles.textStyle16w700(
                                                                                context,

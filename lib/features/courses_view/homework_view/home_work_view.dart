...
print(durationMinutes);
    final allQuestions = CoursesCubit.get(context).homeworkQuestions.expand((q) {
  ...
  Widget _buildQuestionTypeSection(String type, String title) {
    final questions = CoursesCubit.get(context).homeworkQuestions.where((q) => q['type'] == type).toList();
                    ...
                    Padding(
                      ...
                      child: Container(
                        ...
                        child: MaterialButton(
                          onPressed: () async{
                            CoursesCubit.get(context).changeIsSubmissionLoading();
                                  ...
                                  actions: [
                                    SizedBox(
                                      ...
                                      child: TextButton(
                                        ...
                                        onPressed: () {
                                          Navigator.pushAndRemoveUntil(context, CupertinoPageRoute(builder: (context)=>HomeworkResultView(attemptID: CoursesCubit.get(context).homework['attempt']['attempt_id'],)), (context)=>false);

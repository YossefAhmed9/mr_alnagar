...
class _LessonVideoScreenState extends State<LessonVideoScreen> {
  ...
  void _loadVideos() {
    ...
    final savedVideoId = CacheHelper.getData(key: CacheKeys.lastLessonVideoIndex);
      ...
      appBar: isFullScreen ? null : AppBar(
        ...
        actions:[
          Padding(
            ...
            child: Text(LessonsCubit.get(context).courseResult[0]['title'], style: TextStyles.textStyle16w700(context)),
          )
        ],
      ),
                      ...
                      child: SingleChildScrollView(
                        ...
                        child: Column(
                          children: [
                            ..._videos.asMap().entries.map((entry) {
                              ...
                              return InkWell(
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    color: Colors.white,
                                    border: video['index'] == currentVideoIndex
                                        ? Border.all(
                                      color: AppColors.primaryColor,
                                      width: 2,
                                    )
                            ...
                            LessonsCubit.get(context).classData['next_class_id'] != null ?
                            Column(
                              children: [
                      ...
                      child: Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                              ...
                              'تحميل المذكرة',
                                ...
                                if (url != null && url.toString().isNotEmpty) {
                                  ...
                                  if (await canLaunchUrl(uri)) {
                                    ...
                                    LessonsCubit.get(context).showSnackBar(context, 'تعذر فتح الرابط', 3, Colors.red);
                                  }
                                } else {
                                  LessonsCubit.get(context).showSnackBar(context, 'لا يوجد ملف مرفق', 3, Colors.orange);
                                }
                              },
                            )
                                : Container(),
                            ...
                            LessonsCubit.get(context).classData['has_homeworks'] == true
                                ? _buildActionButton(context, Icons.assignment, 'حل الواجب', () async {
                              controller.pause();
                              await LessonsCubit.get(context).startHomework(
                                homeworkId: LessonsCubit.get(context).classData['homework_id'],
                              );
                              ...
                              Navigator.push(context, CupertinoPageRoute(
                                ...
                                : Container(),
                            LessonsCubit.get(context).classData['has_quizzes'] == true

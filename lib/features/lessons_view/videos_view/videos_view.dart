...
bool hd=true;
  ...
  void initState() {
    super.initState();
    LessonsCubit.get(context).getVideosByLesson(id: widget.videoIndex,context: context);
  ...
  Widget _buildActionButton(BuildContext context, IconData icon, String label, VoidCallback onPressed) {
    return InkWell(
      ...
      child: Container(
        ...
        child:
        LessonsCubit.get(context).isLessonLoading ? CircularProgressIndicator()
    ...
    return Scaffold(
      body: RefreshIndicator(
        ...
        onRefresh: (){
          ...
          _loadVideos();
          return   LessonsCubit.get(context).getVideosByLesson(id: widget.videoIndex,context: context);
        ...
        child: Directionality(
          ...
          child: SafeArea(
            child: LessonsCubit.get(context).LessonsVideos == null
                  ...
                  child: Column(
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                    decoration: BoxDecoration(),
                                    child: Text(LessonsCubit.get(context).lessonResult[0]['title'], style: TextStyles.textStyle16w700(context)),
                              ...
                              child: ExpansionTile(
                                ...
                                title: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      section['title'],
                                      style: TextStyles.textStyle14w700(context).copyWith(color: AppColors.secondary80),
                                    ),
                                    const SizedBox(height: 8),
                                    Row(
                                      children: [
                                        section['attachment'] != null
                                            ? _buildActionButton(context, Icons.picture_as_pdf_outlined, 'تحميل المذكرة', () {})
                                            : Container(),
                                        section['has_homeworks'] == true
                                            ? _buildActionButton(context, Icons.assignment, 'حل الواجب', () async{
                                              controller.pause();
                                          await LessonsCubit.get(context).startHomework(homeworkId: LessonsCubit.get(context).LessonsVideos['sections_data'][sectionIndex]['homework_id'],);

                                          Navigator.push(context, CupertinoPageRoute(builder: (context){
                                            return LessonsHomeworkView(homeworkID: LessonsCubit.get(context).LessonsVideos['sections_data'][sectionIndex]['homework_id'],);
                                          }));
                                            })
                                            : Container(),
                                        section['has_quizzes'] == true
                                            ? _buildActionButton(context, Icons.quiz, 'عرض الامتحان', () async{
                                              LessonsCubit.get(context).changeIsLessonLoading();
                                          await  LessonsCubit.get(context).startQuiz(quizId: LessonsCubit.get(context).LessonsVideos['sections_data'][sectionIndex]['quiz_id']);
                                          print(LessonsCubit.get(context).LessonsVideos['sections_data'][sectionIndex]['quiz_id']);
                                              showDialog(
                                                context: context,
                                                      ...
                                                      content: SingleChildScrollView(
                                                        child: Column(
                                                          children: [
                                                            ...
                                                            Container(
                                                              decoration: BoxDecoration(
                                                                color: const Color(0xFFFDF3D0), // keeping your inner box color
                                                              ...
                                                              child: Column(
                                                                children: [
                                                                  LessonsCubit.get(context).quiz == null
                                                                    ...
                                                                    child: Text(
                                                                      HtmlUnescape().convert(LessonsCubit.get(context)
                                                                      ...
                                                                      child: MaterialButton(
                                                                        onPressed: () async {
                                                                          ...
                                                                          await LessonsCubit.get(context).startQuiz(
                                                                            quizId: LessonsCubit.get(context)
                                                                                .LessonsVideos['sections_data'][sectionIndex]
                                                                            ['quiz_id'],
                                                                          );
                                                                          Navigator.pushAndRemoveUntil(
                                                                            ...
                                                                            CupertinoPageRoute(
                                                                              builder: (context) {
                                                                                return ExamView(
                                                                                  quizID: LessonsCubit.get(context)
                                                                                      .LessonsVideos['sections_data']
                                                                                  [sectionIndex]['quiz_id'],
                                                                                );
                                                                              },
                                                                            ),
                                                                                (context) => false,
                                          ...
                                          //Navigator.push(context, CupertinoPageRoute(builder: (_) => ExamView(quizID: CoursesCubit.get(context).coursesVideos['sections_data'][sectionIndex]['quiz_id'])));
                                        }
                                        )
                                            : Container(),
                                      ],
...
print('**********************');
print(parentSection['quiz_required']);
print('**********************');


                                      if (hasQuiz==true && quizAttempted==false && parentSection['quiz_required']==1) {
                                        showDialog(
                                          context: context,
                                                ...
                                                child: TextButton(
                                                  ...
                                                  onPressed: () async {
                                                    ...
                                                    Navigator.push(
                                                      context,
                                                      CupertinoPageRoute(
                                                        builder: (_) => ExamView(quizID: section['quiz_id']),
                                                      ),
                                                    );
                                                  },
                                                  child: Text(

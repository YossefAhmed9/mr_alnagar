...
class HomeWorkResults extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return ProfileCubit.get(context).homeWorksResultsForProfile.isEmpty ?
        Center(child: Text('No Results',style: TextStyles.textStyle20w700(context).copyWith(color: AppColors.primaryColor),),)
     ...
     : Directionality(
      ...
      child: Scaffold(
        body: RefreshIndicator(
          onRefresh: ()async{
            return await ProfileCubit.get(context).getHomeWorksResultsForProfile();
          },
          child: SafeArea(
            child: Scrollbar(

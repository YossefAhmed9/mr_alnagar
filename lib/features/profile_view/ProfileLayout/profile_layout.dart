  ...
  builder: (context, state) {
    ...
    return InternetAwareWrapper(
      onInternetRestored: [
        ...
        ()=>ProfileCubit.get(context).getUserStats(),
        ()=>ProfileCubit.get(context).getHomeWorksResultsForProfile(),
        ()=>ProfileCubit.get(context).getMyCompletedCourses(),
        ()=>ProfileCubit.get(context).getMyInProgressCourses(),
        ()=>ProfileCubit.get(context).getPrivacyPolicy(),
      ],
      child: Scaffold(
